...
class ExchangeRateProviderTest extends TestCase
{
    ...
    public function getExchangeRates(): iterable
    {
        ...
        $testCurrency = new Currency(4, 'Test', 'aaa', 8, '$$', 2);
        $birCurrency = new Currency(5, 'BYR', 'BYR', 20845.295282, 'BYR', 2);

        $fakeCurrencyWithRate0dot5 = new Currency(7, 'Fake 1', 'Fak', 0.5, 'FAK1', 2);
        $fakeCurrencyWithRate2 = new Currency(8, 'Fake 2', 'Fak2', 2, 'FAK2', 2);
